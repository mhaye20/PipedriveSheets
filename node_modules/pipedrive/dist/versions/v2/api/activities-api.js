...
class ActivitiesApi extends base_1.BaseAPI {
     ...
     */
    getActivity(requestParameters) {
        return (0, exports.ActivitiesApiFp)(this.configuration).getActivity(requestParameters.id, requestParameters.include_fields).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the properties of an activity.
     * @summary Update an activity
     ...
     */
    updateActivity(requestParameters) {
        return (0, exports.ActivitiesApiFp)(this.configuration).updateActivity(requestParameters.id, requestParameters.AddActivityRequest).then((request) => request(this.axios, this.basePath));
    }
}
