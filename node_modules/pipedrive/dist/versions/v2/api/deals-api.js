...
class DealsApi extends base_1.BaseAPI {
     ...
     */
    deleteAdditionalDiscount(requestParameters) {
        return (0, exports.DealsApiFp)(this.configuration).deleteAdditionalDiscount(requestParameters.id, requestParameters.discount_id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a deal as deleted. After 30 days, the deal will be permanently deleted.
     * @summary Delete a deal
     ...
     */
    updateAdditionalDiscount(requestParameters) {
        return (0, exports.DealsApiFp)(this.configuration).updateAdditionalDiscount(requestParameters.id, requestParameters.discount_id, requestParameters.UpdateAdditionalDiscountRequestBody).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the properties of a deal.
     * @summary Update a deal
