...
const OrganizationsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addOrganizationFollower: (id, AddOrganizationFollowerRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddOrganizationFollowerRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        getOrganizationActivities: (id, start, limit, done, exclude) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationActivities', 'id', id);
        ...
        getOrganizationChangelog: (id, cursor, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationChangelog', 'id', id);
        ...
        getOrganizationDeals: (id, start, limit, status, sort, only_primary_association) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationDeals', 'id', id);
        ...
        getOrganizationFiles: (id, start, limit, sort) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationFiles', 'id', id);
        ...
        getOrganizationPersons: (id, start, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationPersons', 'id', id);
        ...
        getOrganizationUpdates: (id, start, limit, all_changes, items) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationUpdates', 'id', id);
        ...
        getOrganizationUsers: (id) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getOrganizationUsers', 'id', id);
        ...
        mergeOrganizations: (id, MergeOrganizationsRequest) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('mergeOrganizations', 'id', id);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(MergeOrganizationsRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class OrganizationsApi extends base_1.BaseAPI {
     ...
     */
    addOrganizationFollower(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).addOrganizationFollower(requestParameters.id, requestParameters.AddOrganizationFollowerRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks an organization as deleted. After 30 days, the organization will be permanently deleted.
     * @summary Delete an organization
     ...
     */
    deleteOrganizations(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).deleteOrganizations(requestParameters.ids).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the details of an organization. Note that this also returns some additional fields which are not present when asking for all organizations. Also note that custom fields appear as long hashes in the resulting data. These hashes can be mapped against the `key` value of organizationFields.
     * @summary Get details of an organization
     ...
     */
    getOrganizationActivities(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationActivities(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.done, requestParameters.exclude).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists updates about field values of an organization.
     * @summary List updates about organization field values
     ...
     */
    getOrganizationDeals(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationDeals(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.status, requestParameters.sort, requestParameters.only_primary_association).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists files associated with an organization.
     * @summary List files attached to an organization
     ...
     */
    getOrganizationFiles(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationFiles(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.sort).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists the followers of an organization.
     * @summary List followers of an organization
     ...
     */
    getOrganizationFollowers(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationFollowers(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists mail messages associated with an organization.
     * @summary List mail messages associated with an organization
     ...
     */
    getOrganizationPersons(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationPersons(requestParameters.id, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists updates about an organization.
     * @summary List updates about an organization
     ...
     */
    getOrganizationUpdates(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationUpdates(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.all_changes, requestParameters.items).then((request) => request(this.axios, this.basePath));
    }
    /**
     * List users permitted to access an organization.
     * @summary List permitted users
     ...
     */
    getOrganizationUsers(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationUsers(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns all organizations.
     * @summary Get all organizations
     ...
     */
    getOrganizationsCollection(requestParameters = {}) {
        return (0, exports.OrganizationsApiFp)(this.configuration).getOrganizationsCollection(requestParameters.cursor, requestParameters.limit, requestParameters.since, requestParameters.until, requestParameters.owner_id, requestParameters.first_char).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Merges an organization with another organization. For more information, see the tutorial for <a href=\"https://pipedrive.readme.io/docs/merging-two-organizations\" target=\"_blank\" rel=\"noopener noreferrer\">merging two organizations</a>.
     * @summary Merge two organizations
     ...
     */
    mergeOrganizations(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).mergeOrganizations(requestParameters.id, requestParameters.MergeOrganizationsRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Searches all organizations by name, address, notes and/or custom fields. This endpoint is a wrapper of <a href=\"https://developers.pipedrive.com/docs/api/v1/ItemSearch#searchItem\">/v1/itemSearch</a> with a narrower OAuth scope.
     * @summary Search organizations
     ...
     */
    searchOrganization(requestParameters) {
        return (0, exports.OrganizationsApiFp)(this.configuration).searchOrganization(requestParameters.term, requestParameters.fields, requestParameters.exact_match, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the properties of an organization.
     * @summary Update an organization
