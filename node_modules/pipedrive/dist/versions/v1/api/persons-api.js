...
const PersonsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addPersonFollower: (id, AddPersonFollowerRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddPersonFollowerRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        addPersonPicture: (id, file, crop_x, crop_y, crop_width, crop_height) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('addPersonPicture', 'id', id);
            // verify required parameter 'file' is not null or undefined
            (0, common_1.assertParamExists)('addPersonPicture', 'file', file);
        ...
        deletePersonPicture: (id) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deletePersonPicture', 'id', id);
            const localVarPath = `/persons/{id}/picture`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        getPersonActivities: (id, start, limit, done, exclude) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonActivities', 'id', id);
        ...
        getPersonChangelog: (id, cursor, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonChangelog', 'id', id);
        ...
        getPersonDeals: (id, start, limit, status, sort) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonDeals', 'id', id);
        ...
        getPersonFiles: (id, start, limit, sort) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonFiles', 'id', id);
        ...
        getPersonProducts: (id, start, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonProducts', 'id', id);
        ...
        getPersonUpdates: (id, start, limit, all_changes, items) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonUpdates', 'id', id);
        ...
        getPersonUsers: (id) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getPersonUsers', 'id', id);
        ...
        mergePersons: (id, MergePersonsRequest) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('mergePersons', 'id', id);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(MergePersonsRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class PersonsApi extends base_1.BaseAPI {
     ...
     */
    addPersonFollower(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).addPersonFollower(requestParameters.id, requestParameters.AddPersonFollowerRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Adds a picture to a person. If a picture is already set, the old picture will be replaced. Added image (or the cropping parameters supplied with the request) should have an equal width and height and should be at least 128 pixels. GIF, JPG and PNG are accepted. All added images will be resized to 128 and 512 pixel wide squares.
     * @summary Add person picture
     ...
     */
    addPersonPicture(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).addPersonPicture(requestParameters.id, requestParameters.file, requestParameters.crop_x, requestParameters.crop_y, requestParameters.crop_width, requestParameters.crop_height).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a person as deleted. After 30 days, the person will be permanently deleted.
     * @summary Delete a person
     ...
     */
    deletePersons(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).deletePersons(requestParameters.ids).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the details of a person. Note that this also returns some additional fields which are not present when asking for all persons. Also note that custom fields appear as long hashes in the resulting data. These hashes can be mapped against the `key` value of personFields.<br>If a company uses the [Campaigns product](https://pipedrive.readme.io/docs/campaigns-in-pipedrive-api), then this endpoint will also return the `data.marketing_status` field.
     * @summary Get details of a person
     ...
     */
    getPersonActivities(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonActivities(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.done, requestParameters.exclude).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists updates about field values of a person.
     * @summary List updates about person field values
     ...
     */
    getPersonDeals(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonDeals(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.status, requestParameters.sort).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists files associated with a person.
     * @summary List files attached to a person
     ...
     */
    getPersonFiles(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonFiles(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.sort).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists the followers of a person.
     * @summary List followers of a person
     ...
     */
    getPersonFollowers(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonFollowers(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists mail messages associated with a person.
     * @summary List mail messages associated with a person
     ...
     */
    getPersonProducts(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonProducts(requestParameters.id, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists updates about a person.<br>If a company uses the [Campaigns product](https://pipedrive.readme.io/docs/campaigns-in-pipedrive-api), then this endpoint\'s response will also include updates for the `marketing_status` field.
     * @summary List updates about a person
     ...
     */
    getPersonUpdates(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonUpdates(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.all_changes, requestParameters.items).then((request) => request(this.axios, this.basePath));
    }
    /**
     * List users permitted to access a person.
     * @summary List permitted users
     ...
     */
    getPersonUsers(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonUsers(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns all persons.
     * @summary Get all persons
     ...
     */
    getPersonsCollection(requestParameters = {}) {
        return (0, exports.PersonsApiFp)(this.configuration).getPersonsCollection(requestParameters.cursor, requestParameters.limit, requestParameters.since, requestParameters.until, requestParameters.owner_id, requestParameters.first_char).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Merges a person with another person. For more information, see the tutorial for <a href=\"https://pipedrive.readme.io/docs/merging-two-persons\" target=\"_blank\" rel=\"noopener noreferrer\">merging two persons</a>.
     * @summary Merge two persons
     ...
     */
    mergePersons(requestParameters) {
        return (0, exports.PersonsApiFp)(this.configuration).mergePersons(requestParameters.id, requestParameters.MergePersonsRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Searches all persons by name, email, phone, notes and/or custom fields. This endpoint is a wrapper of <a href=\"https://developers.pipedrive.com/docs/api/v1/ItemSearch#searchItem\">/v1/itemSearch</a> with a narrower OAuth scope. Found persons can be filtered by organization ID.
     * @summary Search persons
