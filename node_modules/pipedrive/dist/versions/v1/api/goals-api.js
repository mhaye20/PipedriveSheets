 ...
 * @export
 */
const GoalsApiAxiosParamCreator = function (configuration) {
    return {
        /**
        ...
        addGoal: (AddGoalRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddGoalRequest, localVarRequestOptions, configuration);
            return {
        ...
        deleteGoal: (id) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('deleteGoal', 'id', id);
        ...
        getGoalResult: (id, period_start, period_end) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getGoalResult', 'id', id);
            // verify required parameter 'period_start' is not null or undefined
            (0, common_1.assertParamExists)('getGoalResult', 'period_start', period_start);
            // verify required parameter 'period_end' is not null or undefined
            (0, common_1.assertParamExists)('getGoalResult', 'period_end', period_end);
        ...
        updateGoal: (id, BasicGoalRequest) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('updateGoal', 'id', id);
            const localVarPath = `/goals/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(BasicGoalRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.GoalsApiAxiosParamCreator = GoalsApiAxiosParamCreator;
/**
...
exports.GoalsApiFp = GoalsApiFp;
/**
 * GoalsApi - factory interface
 * @export
 */
const GoalsApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.GoalsApiFp)(configuration);
    return {
        /**
         * Adds a new goal. Along with adding a new goal, a report is created to track the progress of your goal.
         * @summary Add a new goal
...
exports.GoalsApiFactory = GoalsApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class GoalsApi extends base_1.BaseAPI {
    /**
     * Adds a new goal. Along with adding a new goal, a report is created to track the progress of your goal.
     * @summary Add a new goal
     * @param {GoalsApiAddGoalRequest} requestParameters Request parameters.
     ...
     */
    addGoal(requestParameters = {}) {
        return (0, exports.GoalsApiFp)(this.configuration).addGoal(requestParameters.AddGoalRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a goal as deleted.
     * @summary Delete existing goal
     ...
     */
    deleteGoal(requestParameters) {
        return (0, exports.GoalsApiFp)(this.configuration).deleteGoal(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Gets the progress of a goal for the specified period.
     * @summary Get result of a goal
     ...
     */
    getGoalResult(requestParameters) {
        return (0, exports.GoalsApiFp)(this.configuration).getGoalResult(requestParameters.id, requestParameters.period_start, requestParameters.period_end).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about goals based on criteria. For searching, append `{searchField}={searchValue}` to the URL, where `searchField` can be any one of the lowest-level fields in dot-notation (e.g. `type.params.pipeline_id`; `title`). `searchValue` should be the value you are looking for on that field. Additionally, `is_active=<true|false>` can be provided to search for only active/inactive goals. When providing `period.start`, `period.end` must also be provided and vice versa.
     * @summary Find goals
     ...
     */
    getGoals(requestParameters = {}) {
        return (0, exports.GoalsApiFp)(this.configuration).getGoals(requestParameters.type_name, requestParameters.title, requestParameters.is_active, requestParameters.assignee_id, requestParameters.assignee_type, requestParameters.expected_outcome_target, requestParameters.expected_outcome_tracking_metric, requestParameters.expected_outcome_currency_id, requestParameters.type_params_pipeline_id, requestParameters.type_params_stage_id, requestParameters.type_params_activity_type_id, requestParameters.period_start, requestParameters.period_end).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates an existing goal.
     * @summary Update existing goal
     ...
     */
    updateGoal(requestParameters) {
        return (0, exports.GoalsApiFp)(this.configuration).updateGoal(requestParameters.id, requestParameters.BasicGoalRequest).then((request) => request(this.axios, this.basePath));
    }
}
