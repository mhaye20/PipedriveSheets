...
const ProductsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addProductFollower: (id, AddProductFollowerRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddProductFollowerRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        getProductDeals: (id, start, limit, status) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getProductDeals', 'id', id);
        ...
        getProductFiles: (id, start, limit, sort) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getProductFiles', 'id', id);
        ...
        getProductUsers: (id) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getProductUsers', 'id', id);
...
class ProductsApi extends base_1.BaseAPI {
     ...
     */
    addProductFollower(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).addProductFollower(requestParameters.id, requestParameters.AddProductFollowerRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a product as deleted. After 30 days, the product will be permanently deleted.
     * @summary Delete a product
     ...
     */
    getProductDeals(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).getProductDeals(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.status).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists files associated with a product.
     * @summary List files attached to a product
     ...
     */
    getProductFiles(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).getProductFiles(requestParameters.id, requestParameters.start, requestParameters.limit, requestParameters.sort).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists the followers of a product.
     * @summary List followers of a product
     ...
     */
    getProductFollowers(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).getProductFollowers(requestParameters.id, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Lists users permitted to access a product.
     * @summary List permitted users
     ...
     */
    getProductUsers(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).getProductUsers(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about all products.
     * @summary Get all products
     ...
     */
    getProducts(requestParameters = {}) {
        return (0, exports.ProductsApiFp)(this.configuration).getProducts(requestParameters.user_id, requestParameters.filter_id, requestParameters.ids, requestParameters.first_char, requestParameters.get_summary, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Searches all products by name, code and/or custom fields. This endpoint is a wrapper of <a href=\"https://developers.pipedrive.com/docs/api/v1/ItemSearch#searchItem\">/v1/itemSearch</a> with a narrower OAuth scope.
     * @summary Search products
     ...
     */
    searchProducts(requestParameters) {
        return (0, exports.ProductsApiFp)(this.configuration).searchProducts(requestParameters.term, requestParameters.fields, requestParameters.exact_match, requestParameters.include_fields, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates product data.
     * @summary Update a product
