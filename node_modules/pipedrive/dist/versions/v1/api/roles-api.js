...
const RolesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addOrUpdateRoleSetting: (id, AddOrUpdateRoleSettingRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('addOrUpdateRoleSetting', 'id', id);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddOrUpdateRoleSettingRequest, localVarRequestOptions, configuration);
            return {
        ...
        addRoleAssignment: (id, AddRoleAssignmentRequest) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('addRoleAssignment', 'id', id);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(AddRoleAssignmentRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        deleteRoleAssignment: (id, DeleteRoleAssignmentRequest) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('deleteRoleAssignment', 'id', id);
            const localVarPath = `/roles/{id}/assignments`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(DeleteRoleAssignmentRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        getRoleAssignments: (id, start, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getRoleAssignments', 'id', id);
            const localVarPath = `/roles/{id}/assignments`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        getRolePipelines: (id, visible) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getRolePipelines', 'id', id);
        ...
        getRoleSettings: (id) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getRoleSettings', 'id', id);
            const localVarPath = `/roles/{id}/settings`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        updateRole: (id, BaseRoleRequest) => __awaiter(this, void 0, void 0, function* () {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(BaseRoleRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        updateRolePipelines: (id, PutRolePipelinesBody) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('updateRolePipelines', 'id', id);
            const localVarPath = `/roles/{id}/pipelines`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(PutRolePipelinesBody, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
class RolesApi extends base_1.BaseAPI {
     ...
     */
    addOrUpdateRoleSetting(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).addOrUpdateRoleSetting(requestParameters.id, requestParameters.AddOrUpdateRoleSettingRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Adds a new role.
     * @summary Add a role
     ...
     */
    addRole(requestParameters = {}) {
        return (0, exports.RolesApiFp)(this.configuration).addRole(requestParameters.AddRoleRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Assigns a user to a role.
     * @summary Add role assignment
     ...
     */
    addRoleAssignment(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).addRoleAssignment(requestParameters.id, requestParameters.AddRoleAssignmentRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a role as deleted.
     * @summary Delete a role
     ...
     */
    deleteRole(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).deleteRole(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Removes the assigned user from a role and adds to the default role.
     * @summary Delete a role assignment
     ...
     */
    deleteRoleAssignment(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).deleteRoleAssignment(requestParameters.id, requestParameters.DeleteRoleAssignmentRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the details of a specific role.
     * @summary Get one role
     ...
     */
    getRole(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).getRole(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns all users assigned to a role.
     * @summary List role assignments
     ...
     */
    getRoleAssignments(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).getRoleAssignments(requestParameters.id, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the list of either visible or hidden pipeline IDs for a specific role. For more information on pipeline visibility, please refer to the <a href=\"https://support.pipedrive.com/en/article/visibility-groups\" target=\"_blank\" rel=\"noopener noreferrer\">Visibility groups article</a>.
     * @summary List pipeline visibility for a role
     ...
     */
    getRolePipelines(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).getRolePipelines(requestParameters.id, requestParameters.visible).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the visibility settings of a specific role.
     * @summary List role settings
     ...
     */
    getRoleSettings(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).getRoleSettings(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns all the roles within the company.
     * @summary Get all roles
     ...
     */
    getRoles(requestParameters = {}) {
        return (0, exports.RolesApiFp)(this.configuration).getRoles(requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the parent role and/or the name of a specific role.
     * @summary Update role details
     ...
     */
    updateRole(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).updateRole(requestParameters.id, requestParameters.BaseRoleRequest).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the specified pipelines to be visible and/or hidden for a specific role. For more information on pipeline visibility, please refer to the <a href=\"https://support.pipedrive.com/en/article/visibility-groups\" target=\"_blank\" rel=\"noopener noreferrer\">Visibility groups article</a>.
     * @summary Update pipeline visibility for a role
     ...
     */
    updateRolePipelines(requestParameters) {
        return (0, exports.RolesApiFp)(this.configuration).updateRolePipelines(requestParameters.id, requestParameters.PutRolePipelinesBody).then((request) => request(this.axios, this.basePath));
    }
}
