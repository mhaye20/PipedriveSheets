...
const StagesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        deleteStages: (ids) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('deleteStages', 'ids', ids);
            const localVarPath = `/stages`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
        ...
        getStageDeals: (id, filter_id, user_id, everyone, start, limit) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getStageDeals', 'id', id);
...
class StagesApi extends base_1.BaseAPI {
     ...
     */
    deleteStages(requestParameters) {
        return (0, exports.StagesApiFp)(this.configuration).deleteStages(requestParameters.ids).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about a specific stage.
     * @summary Get one stage
     ...
     */
    getStageDeals(requestParameters) {
        return (0, exports.StagesApiFp)(this.configuration).getStageDeals(requestParameters.id, requestParameters.filter_id, requestParameters.user_id, requestParameters.everyone, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about all stages.
     * @summary Get all stages
     ...
     */
    getStages(requestParameters = {}) {
        return (0, exports.StagesApiFp)(this.configuration).getStages(requestParameters.pipeline_id, requestParameters.start, requestParameters.limit).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the properties of a stage.
     * @summary Update stage details
