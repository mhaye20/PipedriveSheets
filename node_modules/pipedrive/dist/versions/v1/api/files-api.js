...
const FilesApiAxiosParamCreator = function (configuration) {
    return {
        ...
        addFileAndLinkIt: (file_type, title, item_type, item_id, remote_location) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('addFileAndLinkIt', 'file_type', file_type);
            // verify required parameter 'title' is not null or undefined
            (0, common_1.assertParamExists)('addFileAndLinkIt', 'title', title);
            // verify required parameter 'item_type' is not null or undefined
            (0, common_1.assertParamExists)('addFileAndLinkIt', 'item_type', item_type);
            // verify required parameter 'item_id' is not null or undefined
            (0, common_1.assertParamExists)('addFileAndLinkIt', 'item_id', item_id);
        ...
        linkFileToItem: (item_type, item_id, remote_id, remote_location) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'item_type' is not null or undefined
            (0, common_1.assertParamExists)('linkFileToItem', 'item_type', item_type);
            // verify required parameter 'item_id' is not null or undefined
            (0, common_1.assertParamExists)('linkFileToItem', 'item_id', item_id);
            // verify required parameter 'remote_id' is not null or undefined
            (0, common_1.assertParamExists)('linkFileToItem', 'remote_id', remote_id);
            // verify required parameter 'remote_location' is not null or undefined
...
class FilesApi extends base_1.BaseAPI {
     ...
     */
    addFileAndLinkIt(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).addFileAndLinkIt(requestParameters.file_type, requestParameters.title, requestParameters.item_type, requestParameters.item_id, requestParameters.remote_location).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Marks a file as deleted. After 30 days, the file will be permanently deleted.
     * @summary Delete a file
     ...
     */
    deleteFile(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).deleteFile(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Initializes a file download.
     * @summary Download one file
     ...
     */
    downloadFile(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).downloadFile(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about a specific file.
     * @summary Get one file
     ...
     */
    getFile(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).getFile(requestParameters.id).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns data about all files.
     * @summary Get all files
     ...
     */
    getFiles(requestParameters = {}) {
        return (0, exports.FilesApiFp)(this.configuration).getFiles(requestParameters.start, requestParameters.limit, requestParameters.sort).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Links an existing remote file (`googledrive`) to the item you supply. For more information, see the tutorial for <a href=\"https://pipedrive.readme.io/docs/adding-a-remote-file\" target=\"_blank\" rel=\"noopener noreferrer\">adding a remote file</a>.
     * @summary Link a remote file to an item
     ...
     */
    linkFileToItem(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).linkFileToItem(requestParameters.item_type, requestParameters.item_id, requestParameters.remote_id, requestParameters.remote_location).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the properties of a file.
     * @summary Update file details
     ...
     */
    updateFile(requestParameters) {
        return (0, exports.FilesApiFp)(this.configuration).updateFile(requestParameters.id, requestParameters.name, requestParameters.description).then((request) => request(this.axios, this.basePath));
    }
}
