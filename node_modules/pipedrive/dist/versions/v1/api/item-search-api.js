...
const ItemSearchApiAxiosParamCreator = function (configuration) {
    return {
        ...
        searchItemByField: (term, field_type, field_key, exact_match, return_item_ids, start, limit) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('searchItemByField', 'field_type', field_type);
    ...
    return {
        ...
        searchItem(term, item_types, fields, search_for_related_items, exact_match, include_fields, start, limit) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.searchItem(term, item_types, fields, search_for_related_items, exact_match, include_fields, start, limit);
        ...
        searchItemByField(term, field_type, field_key, exact_match, return_item_ids, start, limit) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.searchItemByField(term, field_type, field_key, exact_match, return_item_ids, start, limit);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
    };
